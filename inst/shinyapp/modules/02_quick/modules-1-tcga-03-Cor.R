ui.modules_1_tcga_03 = function(id){
    ns = NS(id)
    main_ui = tagList(
        fluidRow(
            column(6,
                ...
                h4(strong("X-axis:")),
                mol_quick_select_UI(ns("id_1"), "tcga", 
                    c("mRNA","transcript","methylation","miRNA","protein", "cnv"))
            ),
            column(6,
                h4(strong("Y-axis:")),
                mol_quick_select_UI(ns("id_2"), "tcga", 
                    c("mRNA","transcript","methylation","miRNA","protein", "cnv"))
            )
        ),
...
server.modules_1_tcga_03 = function(input, output, session){
    ns = session$ns
