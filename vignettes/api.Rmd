...
```{r eval=FALSE}
miRNA_expr <- query_value("hsa-let-7a-2-3p", data_type = "miRNA")
```
...
```{r echo=FALSE}
tryCatch(
  knitr::include_graphics("https://gitee.com/ShixiangWang/ImageCollection/raw/master/png/20210322130516.png"),
  error = function(e) {
    print("Cannot query the figure, please type the URL by yourself: https://gitee.com/ShixiangWang/ImageCollection/raw/master/png/20210322130516.png")
  }
)
```
