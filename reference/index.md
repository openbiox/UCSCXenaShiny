...
- [`get_ccle_gene_value()`](https://openbiox.github.io/UCSCXenaShiny/reference/get_pancan_value.md)
  ...
  [`get_pcawg_cn_value()`](https://openbiox.github.io/UCSCXenaShiny/reference/get_pancan_value.md)
...
- [`vis_ccle_gene_cross_omics()`](https://openbiox.github.io/UCSCXenaShiny/reference/vis_ccle_gene_cross_omics.md)
  : Visualize cross-omics of one gene in CCLE
- [`vis_pcawg_gene_cross_omics()`](https://openbiox.github.io/UCSCXenaShiny/reference/vis_pcawg_gene_cross_omics.md)
  : Visualize cross-omics of one gene in PCAWG
- [`vis_pcawg_pathway_cross_omics()`](https://openbiox.github.io/UCSCXenaShiny/reference/vis_pcawg_pathway_cross_omics.md)
